      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="masakerja.php">Masa Kerja</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <!-- <a href="#" class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm" data-toggle="modal"><i -->
                <!-- class="fas fa-angle-double-down fa-sm text-white-50"></i> Tambah</a> -->
            ...
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Masa Kerja</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="custom-file col-md-6 justify-content-center">
                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                      <thead class="table-info">
                        <tr>
                          ...
                          <th class="mk">Tahun</th>
                          <th class="mk">Bulan</th>
                          <th class="mk">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td>Pengelola Keuangan pada MTsN 1 Bone Bolango</td>
                          <td class="mk">5</td>
                          <td class="mk">0</td>
                          <td class="mk">
                        ...
                        <tr>
                          <td>Pengadministrasi pada Dinas Pemuda dan Olahraga Pemerintah Provinsi Gorontalo</td>
                          <div class="mk">
                          <td class="mk">2</td>
                          <td class="mk">0</td>
                          <td class="mk">
