              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="card shadow mb-4  border-left-danger">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-danger">Sekolah Dasar</h6>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-8">
                ...
                <div class="col-lg-6">
                  <div class="card shadow mb-4 border-left-primary">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-primary">Sekolah Menengah Pertama</h6>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-8">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="card shadow mb-4 border-left-secondary">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-secondary">Sekolah Menengah Atas</h6>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-8">
                ...
                <div class="col-lg-6">
                  <div class="card shadow mb-4 border-left-success">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-success">Strata 1</h6>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-8">
